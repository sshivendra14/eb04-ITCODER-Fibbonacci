...
:--|:--|:--|:--:
1.| Student will enter any number in between 1-7.|<div align="justify"> Based on user input n value fibbonacci series computed step by step.</div> |<div align="justify">User will be able to visualize the recursion concept.</div>
